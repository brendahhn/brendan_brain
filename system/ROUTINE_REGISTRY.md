...
| Brendan OS (this) | brendan_brain | on demand / scheduled | **07:10 editorial**, publication target ~07:25 (gate: tools/check_inputs.py) | the whole repo | newspaper editions, queue, Brain state | general |
