...
1. **Job search** — daily robot; highest consequence.
...
Triage rule: when capacity is contended, order = deadline-bearing tasks → priorities above →
watches → background research (system/CAPACITY_LEDGER.md).
